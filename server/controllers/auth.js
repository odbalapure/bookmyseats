...
const register = async (req, res) => {
  ...
  transporter.sendMail({
    ...
    subject: "BookMySeats - Email Confirmation",
    html: `<h4>Hi ${user.name}! Please click the below link to activate your account.</h4>
      <p>Confirm email for <a href="https://bookmyseats.herokuapp.com/api/v1/auth/confirm/${token}">${user.email}</a></p>
    `,
  });
...
const confirm = async (req, res) => {
  ...
  res.send(`<h3><u>BookMySeats</u></h3>
      <p style="color: green;"><b>Hi there, your account has been activated!</b></p>
      <p>You can book movies shows online on BookMySeats!</p>
    `);
};
